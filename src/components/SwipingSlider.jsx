      ...
      >
        {content.slides.map((slide) => (
          <SwiperSlide key={slide.title} className="!w-64 md:!w-72 2xl:!w-96">
            <div className="w-56 shadow-[5px_-10px_10px_rgb(0,0,0,0.1)] rounded-t-3xl md:w-60 2xl:w-80">
              <p className=" text-center font-semibold py-4 text-xl md:text-xl md:py-8 2xl:py-14 2xl:text-2xl">
                {slide.title}
              </p>
              <img src={slide.img} />
            </div>
